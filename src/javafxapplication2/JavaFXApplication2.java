...
public class JavaFXApplication2 extends Application {
    ...
    public static void main(String[] args) {
        ...
        allParts.add(new InHouse(11, "3", "Nuts", 11, "4.30", 6, 1));
        allParts.add(new InHouse(12, "4", "Walnuts", 13, "10.20", 3, 1));
        ...
        associatedParts3.add(new InHouse(11, "3", "Nuts", 11, "4.30", 6, 1));
        
        ObservableList<Parts> associatedParts4 = FXCollections.observableArrayList();
        associatedParts4.add(new InHouse(12, "3", "Walnuts", 13, "10.20", 3, 1));
